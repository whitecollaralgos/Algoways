...
def map_order_data(order_data):
    ...
    Returns:
    - List of mapped orders in AlgoWays format
    """
    ...
    for order in orders:
        mapped_order = {}
        # Get AlgoWays symbol from token
...
def transform_order_data(orders):
    """
    Transform order data to match AlgoWays format.
...
def map_trade_data(trade_data):
    ...
    Returns:
    - List of mapped trades in AlgoWays format
    """
    # If it's a list, data is already mapped
...
def transform_tradebook_data(trades):
    """
    Transform trade data to match AlgoWays format.
...
def map_portfolio_data(portfolio_data):
    ...
    Returns:
    - List of mapped holdings in AlgoWays format
    """
...
def transform_holdings_data(holdings):
    """
    Transform holdings data to match AlgoWays format.
...
def map_position_data(position_data):
    ...
    Returns:
    - List of mapped positions in AlgoWays format
    """
    # If it's a list, data is already mapped
...
def transform_positions_data(positions):
    """
    Transform position data to match AlgoWays format.
