...
class WisdomExchangeMapper:
    """Maps between AlgoWays exchange codes and Wisdom XTS specific exchange types"""
    
    # Exchange type mapping for Wisdom XTS broker
    # Format: {AlgoWays_Exchange: Wisdom_Exchange_Code}
    ...
    # Reverse mapping for converting Wisdom exchange codes to AlgoWays format
    # Format: {Wisdom_Exchange_Code: AlgoWays_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert AlgoWays exchange code to Wisdom XTS specific exchange type
    ...
    @staticmethod
    def get_algoways_exchange(wisdom_code):
        """
        Convert Wisdom XTS exchange code to AlgoWays exchange code
        ...
        """
        return WisdomExchangeMapper.REVERSE_EXCHANGE_TYPES.get(wisdom_code, 'NSE')  # Default to NSE if not found
