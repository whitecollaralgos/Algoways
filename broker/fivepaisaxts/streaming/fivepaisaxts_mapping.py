...
class FivepaisaXTSExchangeMapper:
    """Maps between AlgoWays exchange codes and Fivepaisa XTS specific exchange types"""
    
    # Exchange type mapping for Fivepaisa XTS broker
    # Format: {AlgoWays_Exchange: Fivepaisa_Exchange_Code}
    ...
    # Reverse mapping for converting Fivepaisa exchange codes to AlgoWays format
    # Format: {Fivepaisa_Exchange_Code: AlgoWays_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert AlgoWays exchange code to Fivepaisa XTS specific exchange type
    ...
    @staticmethod
    def get_algoways_exchange(fivepaisaxts_code):
        """
        Convert Fivepaisa XTS exchange code to AlgoWays exchange code
        ...
        """
        return FivepaisaXTSExchangeMapper.REVERSE_EXCHANGE_TYPES.get(fivepaisaxts_code, 'NSE')  # Default to NSE if not found
